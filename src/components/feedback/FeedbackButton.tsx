  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-[#2a2a2a] border border-[#404040] text-white hover:text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center gap-2 z-40 group"
      >
        <svg
          className="w-5 h-5"
          fill="none"
            ...
            <div className="p-6">
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-white">We&apos;ll use this to make things better.</p>
                </div>
              ) : (
                <>
                  <textarea
