    ...
    <>
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center justify-center w-8 h-8 text-white hover:text-white transition-colors focus:outline-none"
          aria-label="Menu"
        >
              ...
              {feedbackSent ? (
                ...
                <>
                  <textarea
                    ...
                    rows={3}
                    autoFocus
                    className="w-full px-3 py-2 text-sm bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg text-white placeholder:text-white focus:outline-none focus:border-[#404040] resize-none"
                  />
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs font-medium bg-[#2a2a2a] text-white rounded-lg hover:bg-[#333333] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                    >
            ...
            <>
              ...
              <div className="py-1">
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 text-sm text-white hover:bg-[#1a1a1a] transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 w-full px-4 py-2.5 text-sm text-white hover:bg-[#1a1a1a] transition-colors"
                >
                  <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
