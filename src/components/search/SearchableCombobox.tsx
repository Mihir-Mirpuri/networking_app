    ...
    <div>
      ...
      >
        <div className="relative">
          ...
          <Combobox.Options className="absolute z-20 mt-1.5 max-h-60 w-full overflow-auto rounded-xl bg-[#303030] py-1.5 text-base shadow-lg border border-[#404040] focus:outline-none sm:text-sm">
