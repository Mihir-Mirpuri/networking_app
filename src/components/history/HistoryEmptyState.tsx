  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <button
        ...
        className="flex items-center gap-3 px-6 py-3 rounded-xl bg-[#6364FF] hover:bg-[#7879ff] text-white font-semibold transition-all hover:shadow-lg hover:shadow-[#6364FF]/25"
      >
