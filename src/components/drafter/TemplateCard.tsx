...
import { PresetTemplate } from '@/lib/services/drafter';
...
export function TemplateCard({ template, onClick, disabled }: TemplateCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="w-full p-4 text-left bg-[#1a1a1a] border border-[#303030] rounded-lg hover:border-[#404040] hover:bg-[#202020] transition-colors disabled:opacity-50 disabled:cursor-not-allowed group"
    >
